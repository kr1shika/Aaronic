  ...
  return (
    <>
      ...
      <main className="pt-28">
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-br from-red-50 via-white to-red-50 py-24">
          ...
          <div className="max-w-6xl mx-auto px-6 relative">
            ...
            <p className="mt-6 text-lg text-gray-600 max-w-3xl leading-relaxed">
              Canada offers top-ranked universities and colleges that attract international students. In fact, multiple Canadian universities are included in the QS World University Rankings 2024. Studying in Canada is also affordable, with lower tuition fees compared to other popular study destinations.
            </p>
            <p className="mt-4 text-red-700 font-medium max-w-3xl">
            ...
            {/* <div className="mt-8 flex flex-wrap gap-4">
              <button className="bg-red-600 text-white px-8 py-3.5 rounded-full hover:bg-red-700 transition flex items-center gap-2">
                Apply Now <ArrowRight size={18} />
              </button>
              <button className="border border-red-600 text-red-600 px-8 py-3.5 rounded-full hover:bg-red-50 transition">
                Book Consultation
              </button>
            </div> */}
          </div>
        ...
        <section className="py-24">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mt-2">Why Study in Canada?</h2>
                ...
                return (
                  ...
                  >
                    <div className="flex-shrink-0 flex items-center gap-3">
                      ...
                      <div className="w-10 h-10 rounded-xl bg-red-100 text-red-600 flex items-center justify-center md:hidden">
                        <Icon size={20} />
                      </div>
                    </div>
                    <div>
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-red-100 text-red-600 items-center justify-center hidden md:flex">
                          <Icon size={20} />
                        </div>
        ...
        <section className="py-24">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mt-2">Documents for Application</h2>
              <div className="w-20 h-1 bg-red-600 mx-auto mt-4"></div>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-2xl border shadow-sm">
                ...
                <div className="mb-6 p-4 bg-slate-50 rounded-xl">
                  <h4 className="font-bold text-red-600">Bachelor's Degree Program</h4>
                ...
                <div className="p-4 bg-slate-50 rounded-xl">
                  <h4 className="font-bold text-red-600">Master's Degree Program</h4>
                  <ul className="mt-2 space-y-2 text-gray-600">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="text-green-500 mt-1 flex-shrink-0" size={16} />
              ...
              <div className="bg-white p-8 rounded-2xl border shadow-sm">
                ...
                <div className="mb-6 p-4 bg-slate-50 rounded-xl">
                  <h4 className="font-bold text-red-600">IELTS Requirements</h4>
                  <p className="text-sm text-gray-500 mt-1">Overall band score of 6.0 and above</p>
                ...
                <div className="p-4 bg-slate-50 rounded-xl">
                  <h4 className="font-bold text-red-600">PTE Requirements</h4>
                  <div className="mt-3 space-y-2">
                    <div className="flex justify-between items-center p-2 bg-white rounded-lg border">
                      <span className="text-gray-700">Certificate/Diploma/Bachelor's</span>
            ...
            <div className="mt-8 grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-2xl border shadow-sm">
                <h4 className="font-bold text-lg mb-2">Visa Application Fee</h4>
                <p className="text-3xl font-bold text-red-600">CAD $150</p>
                <p className="text-sm text-gray-500 mt-1">Covers the cost of processing your student visa application</p>
              </div>
              <div className="bg-white p-6 rounded-2xl border shadow-sm">
                <h4 className="font-bold text-lg mb-2">Biometrics Fee</h4>
                <p className="text-3xl font-bold text-red-600">CAD $85</p>
                <p className="text-sm text-gray-500 mt-1">For fingerprints and photo required as part of your student visa application</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-red-600 text-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-4xl md:text-5xl font-bold">Start Your Canadian Journey Today</h2>
            ...
            <button className="mt-8 bg-white text-red-600 px-10 py-4 rounded-full font-semibold hover:bg-red-50 transition shadow-lg">
