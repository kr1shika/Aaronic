    ...
    return (
        <>
            ...
            <main className="pt-18">
                ...
                <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-70 py-12 md:py-12">
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-4">
                                    <span className="bg-red-100 text-[#52a4bd] px-4 py-1.5 rounded-full text-sm font-medium">
                                        Study Destination
                                    </span>
                                </div>
                                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                                    Study in the <span className="text-[#52a4bd]">USA</span>
                                </h1>
                                ...
                                <p className="mt-3 md:mt-4 text-[#52a4bd] font-medium">
                ...
                <section className="py-16 md:py-24">
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="text-center mb-12 md:mb-16">
                            <span className="text-[#52a4bd] font-semibold text-sm uppercase tracking-wider">Why USA</span>
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-2">Why Study in the USA?</h2>
                            <div className="w-20 h-1 bg-[#52a4bd] mx-auto mt-4"></div>
                        </div>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                            {benefits.map((benefit, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-blue-100 text-[#52a4bd] flex items-center justify-center mb-3 md:mb-4 group-hover:bg-[#52a4bd] group-hover:text-white transition">
                ...
                <section className="py-16 md:py-24 bg-slate-50">
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="text-center mb-12 md:mb-16">
                            <span className="text-[#52a4bd] font-semibold text-sm uppercase tracking-wider">Application Process</span>
                            ...
                            {applicationSteps.map((step, index) => (
                                ...
                                >
                                    <div className="flex-shrink-0">
                                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-[#52a4bd] text-white flex items-center justify-center text-lg md:text-2xl font-bold">
                                            {step.number}
                                        </div>
                                    </div>
                                    <div>
                ...
                <section className="py-16 md:py-24">
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="text-center mb-12 md:mb-16">
                            <span className="text-[#52a4bd] font-semibold text-sm uppercase tracking-wider">Requirements</span>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-8 md:mb-12">
                            <div className="bg-white p-6 md:p-8 rounded-2xl border shadow-sm">
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg bg-red-100 text-[#52a4bd] flex items-center justify-center">
                                    ...
                                    <table className="w-full text-sm">
                                        ...
                                        <tbody>
                                            <tr className="border-b hover:bg-slate-50">
                                                ...
                                                <td className="p-3 text-center font-bold text-[#52a4bd]">80</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div className="bg-white p-6 md:p-8 rounded-2xl border shadow-sm">
                            ...
                            <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                                <div className="p-4 bg-slate-50 rounded-xl">
                                    <h4 className="font-semibold text-[#52a4bd]">Public Universities</h4>
                ...
                {/* CTA Section */}
                <section className="py-16 md:py-20 bg-[#52a4bd] text-white">
                    <div className="max-w-4xl mx-auto px-6 text-center">
                        ...
                        <button className="mt-6 md:mt-8 bg-white text-[#52a4bd] px-8 md:px-10 py-3 md:py-4 rounded-full font-semibold hover:bg-red-50 transition shadow-lg text-sm md:text-base">
