            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div>
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                  Study in <span className="text-red-600">China</span>
                </h1>
        ...
        <section className="py-16 md:py-24">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12 md:mb-16">
              <span className="text-red-600 font-semibold text-sm uppercase tracking-wider">Why China</span>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      <tr className="border-b hover:bg-slate-50">
                        ...
                        <td className="p-3 text-center">5.5</td>
                        <td className="p-3 text-center font-bold text-red-600">6.0</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="bg-white p-6 md:p-8 rounded-2xl border shadow-sm">
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-slate-50 rounded-xl">
                    <h4 className="font-semibold text-red-600">Bachelor's Programs</h4>
